...
import { Activity, ChevronRight, ChevronLeft, Sun, Moon, Users, BarChart3, CheckCircle2 as CheckCircle } from "lucide-react";
...
export default function OnboardingPage() {
    ...
    const panelStats = [
        ...
        { icon: <BarChart3 size={14}  />, label: "Risk alerts caught early", value: "94%" },
