...
export default function ClientOnboardingPage({ params }: { params: { token: string } }) {
            ...
            {step === 1 ? (
                <Card className="w-full max-w-lg bg-neutral-900 border-neutral-800">
                    <CardHeader className="text-center">
                        <CardTitle className="text-3xl text-white">Welcome to Kinetiq</CardTitle>
                ...
                <Card className="w-full max-w-lg bg-neutral-900 border-neutral-800">
                    <CardHeader>
                        ...
                        <CardDescription className="text-neutral-400">Tell us a bit about your fitness journey.</CardDescription>
                    </CardHeader>
